    ...
    return(
        <>
            ...
            <Card.Img variant="top" className="work-p4" src={p4img} />
                <Card.Body>
                <Card.Title><a href="/mekenziehayford/instainspire"><h4>Insta Inspire</h4></a></Card.Title>
                <Card.Text>
            ...
            <Card.Img variant="top" className="work-p1" src={p1img}/>
                <Card.Body>
                    <Card.Title ><a href="/mekenziehayford/recollection"><h4>Recollection</h4></a></Card.Title>
